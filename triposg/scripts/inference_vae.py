...
def convert_mesh_to_surface(mesh: trimesh.Trimesh, num_points: int = 204800):
    """
    Convert a trimesh mesh to a surface point cloud with normals.
    :param mesh: trimesh.Trimesh object
    :param num_points: Number of points to sample from the mesh
    :return: A tensor of shape (1, num_points, 6) containing points and normals
    """
    surface_points, surface_normals = mesh.sample(num_points, return_normals=True)
